function [ varargout ] = TrainPGdiscreteNewObs_solveMyProblem( varargin )
...
%             problem_iter=problem;
            while runCondition
                ...
                try
                    % Output solutions 
                    [solution]=runPostSolveTasks(problem,solution,options,data); 
                    ...
                    ErrorMatrix = max(solution.Error - problem.states.xErrorTol_local,[],2);  
                    RErrorMatrix = max(solution.ErrorRelative - problem.states.xErrorTol_local,[],2); 
                    ...
                    if i ~= 1 
                        ...
                        env.Reward = env.getReward(R_ErrorMatrix, solution.MaxAbsError,problem.states.xErrorTol_local,problem.states.xConstraintTol,compTime,action{1}); 
